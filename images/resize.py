...
input_dirs = list(('raw\\enemy\\basic\\', 'raw\\enemy\\boss\\', 'raw\\enemy\\medium\\', 'raw\\pet\\', 'raw\\player\\', 'raw\\ui\\', 'raw\\weapon\\basic\\', 'raw\\weapon\\medium\\', 'raw\\weapon\\Ultimate\\'))
...
sizes = list(("basic enemy", "boss enemy", "medium enemy", "pet", "player", "ui", "basic weapon", "medium weapon", "ultimate weapon"))
folders = list(('basic enemy', 'boss enemy', 'medium enemy', 'pet', 'player', 'ui', 'basic weapon', 'medium weapon', 'ultimate weapon'))

for i in range (len(input_dirs)):
    wanted_width = json_data[sizes[i]]
    print ('Měním velikost: ' + str(folders[i]) + ' na: ' + str(json_data[sizes[i]]) + ' pixelů na šířku.')
